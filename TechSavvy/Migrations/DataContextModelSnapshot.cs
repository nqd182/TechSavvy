...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechSavvy.Models.AppUserModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechSavvy.Models.AppUserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechSavvy.Models.OrderDetails", b =>
                {
                    b.HasOne("TechSavvy.Models.ProductModel", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TechSavvy.Models.RatingModel", b =>
                {
                    b.HasOne("TechSavvy.Models.ProductModel", "Product")
                        .WithOne("Ratings")
                        .HasForeignKey("TechSavvy.Models.RatingModel", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
